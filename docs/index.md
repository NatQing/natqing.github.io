...
<section class="hero-row home-hero">
  ...
  <div class="hero-copy wow animated fadeInUp">
    ...
    <p>Right now, I’m working at the UW Institute for Protein Design on the De Novo Design of Electron and Energy Conductive Protein Nanowires. Before that, I’ve bounced between synthetic biology, biomaterials, bioprinting, vascular modeling, and robotics—which is probably a good summary of how easily I get interested in new problems.</p>
